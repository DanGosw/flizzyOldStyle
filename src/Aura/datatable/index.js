        ...
        rowRadiobutton: {
            ...
            box: ({ props }) => ({
                class: [
                    ...
                    {
                        "peer-hover:border-surface-400 dark:peer-hover:border-surface-400": !props.disabled && !props.invalid &&
                            props.value !== props.modelValue,
                        "peer-hover:border-primary-hover": !props.disabled && props.value === props.modelValue && props.value !== undefined,
                        "peer-hover:[&>*:first-child]:bg-primary-600 dark:peer-hover:[&>*:first-child]:bg-primary-300": !props.disabled &&
        ...
        headercheckbox: {
            ...
            box: ({ props, context }) => ({
                class: [
                    ...
                    // States
                    {
                        "peer-hover:border-surface-400 dark:peer-hover:border-surface-600": !props.disabled && !context.checked &&
                            !props.invalid,
