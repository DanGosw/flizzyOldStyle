    ...
    button: {
        root: ({ props, context, parent }) => ({
            class: [
                ...
                {
                    "text-surface-500 dark:text-surface-300 border border-surface-500 hover:bg-surface-300/10": props.outlined &&
                        props.severity === "secondary" && !props.plain
                },
                ...
                // Success Button
                {
                    ...
                    "border border-green-500 dark:border-green-400": props.severity === "success" && !props.text && !props.outlined &&
                        !props.plain
                },
                // Success Text Button
                ...
                {
                    "text-green-500 border border-green-500 hover:bg-green-300/10": props.outlined && props.severity === "success" &&
                        !props.plain
                },
                ...
                // Info Button
                {
                    ...
                    "border border-blue-500 dark:border-blue-400": props.severity === "info" && !props.text && !props.outlined &&
                        !props.plain
                },
                // Info Text Button
                ...
                {
                    "text-blue-500 border border-blue-500 hover:bg-blue-300/10 ": props.outlined && props.severity === "info" &&
                        !props.plain
                },
                ...
                // Help Button
                {
                    ...
                    "border border-purple-500 dark:border-purple-400": props.severity === "help" && !props.text && !props.outlined &&
                        !props.plain
                },
                // Help Text Button
                ...
                {
                    "text-purple-500 border border-purple-500 hover:bg-purple-300/10": props.outlined && props.severity === "help" &&
                        !props.plain
                },
                ...
                // Danger Button
                {
                    ...
                    "border border-red-500 dark:border-red-400": props.severity === "danger" && !props.text && !props.outlined &&
                        !props.plain
                },
                // Danger Text Button
                ...
                // Contrast Button
                {
                    ...
                    "border border-surface-900 dark:border-surface-0": props.severity === "contrast" && !props.text && !props.outlined &&
                        !props.plain
                },
                ...
                {
                    "text-surface-900 dark:text-surface-0 border border-surface-900 dark:border-surface-0": props.outlined &&
                        props.severity === "contrast" && !props.plain
                },
                ...
                // Secondary
                {
                    "hover:bg-surface-200 dark:hover:bg-surface-600 hover:border-surface-200 dark:hover:border-surface-600": props.severity ===
                        "secondary" && !props.text && !props.outlined && !props.plain
                },
                ...
                // Success
                {
                    "hover:bg-green-600 dark:hover:bg-green-300 hover:border-green-600 dark:hover:border-green-300": props.severity ===
                        "success" && !props.text && !props.outlined && !props.plain
                },
                ...
                // Info
                {
                    "hover:bg-blue-600 dark:hover:bg-blue-300 hover:border-blue-600 dark:hover:border-blue-300": props.severity ===
                        "info" && !props.text && !props.outlined && !props.plain
                },
                ...
                // Help
                {
                    "hover:bg-purple-600 dark:hover:bg-purple-300 hover:border-purple-600 dark:hover:border-purple-300": props.severity ===
                        "help" && !props.text && !props.outlined && !props.plain
                },
                ...
                // Danger
                {
                    "hover:bg-red-600 dark:hover:bg-red-300 hover:border-red-600 dark:hover:border-red-300": props.severity === "danger" &&
                        !props.text && !props.outlined && !props.plain
                },
                ...
                // Contrast
                {
                    "hover:bg-surface-800 dark:hover:bg-surface-100 hover:border-surface-800 dark:hover:border-surface-100": props.severity ===
                        "contrast" && !props.text && !props.outlined && !props.plain
                },
                { "focus:ring-surface-500 dark:focus:ring-surface-400": props.severity === "contrast" },
                // Text & Outlined Button
                {
                    "hover:bg-surface-900/10 dark:hover:bg-[rgba(255,255,255,0.03)]": (props.text || props.outlined) && props.severity ===
                        "contrast" && !props.plain
                },
