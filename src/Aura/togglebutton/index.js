export default {
    root: ({ props, context }) => ({
        class: [
            ...
            "bg-surface-100 dark:bg-surface-950",
            {
                ...
                "text-surface-800 dark:text-white/80 before:bg-surface-300 dark:before:bg-surface-800": context.active
            },
    ...
    label: "font-medium leading-[normal] text-center w-full z-10 relative text-[14px]",
