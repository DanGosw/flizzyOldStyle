...
const { parameters } = defineProps({
    ...
    parameters: {
        default: {
             ...
             */
            width: { type: String, default: "50vh" },
            /**
...
<template>
    <Dialog :breakpoints="{'960px': '75vw', '640px': '90vw'}" v-model:visible="parameters.visible" modal closable
            :style="{'width': width > 960 ? parameters?.['width'] : width > 790 ? '80vw' : '95vw'}" @keyup.esc="parameters.visible = false">
        <template #closeicon>
