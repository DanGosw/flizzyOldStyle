...
<template>
    <p-card class="border border-[#dadaea] dark:border-[#474751] m-0 p-0">
        <template #content>
            ...
            <div class="flex flex-wrap gap-2 card">
                ...
                <div class="flex card justify-content-center">
                    <p-dropdown v-model="selectedCity" :options="countries" optionLabel="name" class="w-full" filter show-clear
            ...
            <p-dataTable size="small" striped-rows show-gridlines :value="products" scrollable scroll-direction="horizontal"
                         dataKey="code" tableStyle="min-width: 30rem; font-size: 13px;" class="mt-4">
                <template #header>
